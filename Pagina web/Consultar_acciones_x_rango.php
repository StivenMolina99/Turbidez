...
if ($_SESSION["autenticado"] != "SIx3")
    ...
    {      
        $mysqli = new mysqli($host, $user, $pw, $db);
  	    $sqlusu = "SELECT * from tipo_usuario where id='1'"; //CONSULTA EL TIPO DE USUARIO CON ID=1, TIPO Administrador
   ...
   ?> 
     ...
     <html>
       <head>
           <title> Acciones realizadas por rango de fechas
...
$sql1 = "SELECT * from Registro_acciones where  fecha >= '$fecha_ini' and fecha <= '$fecha_fin' order by fecha DESC"; 
...
<?php
 ...
 echo '
      <tr>	
        <form method=POST action="Consultar_acciones_x_rango.php">
