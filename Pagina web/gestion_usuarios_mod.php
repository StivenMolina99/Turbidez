...
if ((isset($_POST["Modificar"])))
  {
   ...
   $sqlu5 = "UPDATE usuarios set fecha_nacimiento='$fecha_nacimiento' where id='$id_usu_enc'"; 
	   ...
	   <tr valign="top">
	     ...
	     <tr>
           ...
           ?>
			  ...
			  <tr>
				<td bgcolor="#A8DDA8" align=center> 
				  <font FACE="arial" SIZE=2 color="#004400"> <b>Clave (dejar en blanco para no cambiar)</b></font>  
				</td>
				<td bgcolor="#EEEEEE" align=center> 
...
<select name=activo required> 
         ...
         <table width=50% align=center border=0>
           <tr>  
             <td width=50%></td>                                                                       
             <td align=center><input style="background-color: #1A9CF7" type=submit color= blue value="Modificar" name="Modificar">
                  </form> 
             </td>  
             <td align=left>
